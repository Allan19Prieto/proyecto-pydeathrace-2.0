...
'''Vector lo tomamos de esta direccion, donde se encuentra todos las funciones que contiene vector
Link: https://github.com/PythonProgramming/Beginning-Game-Development-with-Python-and-Pygame/blob/master/Chapter%208/gameobjects/vector2.py
y algunos links donde se puede ver su funcionamiento
link: https://www.kite.com/python/docs/pygame.Vector2'''
