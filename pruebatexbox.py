...
# Load images
boardRoom = pygame.image.load("img/pista2.jpg")
...
def new_game():
    ...
    regionsTower = pygame.image.load("img/pista2.jpg")
    petroTower = pygame.image.load("img/pista2.jpg")
    beairdTower = pygame.image.load("img/pista2.jpg")
